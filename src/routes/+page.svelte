...
<!-- Research Areas -->
<div class="research-areas flex flex-col mt-40 items-center m-auto text-white max-w-7xl">
    <h1 class="italic text-5xl font-semibold scroll-m-20 text-black underline mb-20">RESEARCH AREAS</h1>
...
<!-- Recent News -->
<div class="news mt-40 font-semibold text-white max-w-7xl">
